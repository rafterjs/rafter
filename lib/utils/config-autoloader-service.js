...
export default class ConfigAutoloaderService {
    ...
    async get(directory) {
        ...
        for (const fileName of files) {
            ...
            this._logger.debug(`RecursiveConfigLoader::get checking path ${pathname}`);
            ...
            } else if (await this._isDirectory(pathname) && !this._isIgnoredDirectory(pathname)) {
